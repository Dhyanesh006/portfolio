  ...
  return (
    <motion.nav
      ...
      className={cn(
        ...
        scrolled
          ? "bg-[#050816]/80 backdrop-blur-xl border-b border-white/5 shadow-lg shadow-black/20"
          : "bg-transparent"
      )}
    >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="md:hidden bg-[#050816]/95 backdrop-blur-xl border-b border-white/5 overflow-hidden"
          >
