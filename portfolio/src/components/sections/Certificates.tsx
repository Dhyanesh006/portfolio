        ...
        <div className="relative">
          ...
          <div className="flex justify-center gap-3 mt-8">
            <button
              ...
              className="w-10 h-10 rounded-full border border-[#FFFFFF]/20 flex items-center justify-center text-[#A3A3A3] hover:text-[#FFFFFF] hover:border-[#FFFFFF]/50 transition-all"
