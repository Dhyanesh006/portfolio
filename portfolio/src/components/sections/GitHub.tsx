      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            <GithubIcon className="w-12 h-12 text-[#888888] mx-auto mb-4" />
            ...
            >
              <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="text-center md:text-left">
                  ...
                  {profile.bio && (
                    <p className="text-[#888888] text-sm mt-1">{profile.bio}</p>
                  )}
                </div>
                <div className="flex gap-8 md:ml-auto">
                  <div className="text-center">
                    <div className="flex items-center gap-1 text-[#888888] text-xs mb-1">
              ...
              {repos.map((repo, i) => (
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <ExternalLink
                      size={14}
                      className="text-[#888888] shrink-0 ml-2 opacity-0 group-hover:opacity-100 transition-opacity"
                    />
                  </div>

                  <p className="text-[#888888] text-xs leading-relaxed mb-4 line-clamp-2 min-h-[2.5rem]">
