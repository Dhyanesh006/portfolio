      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="relative">
          ...
          {EXPERIENCES.map((exp, i) => (
            ...
            >
              <div className="absolute left-6 md:left-1/2 -translate-x-1/2 w-12 h-12 rounded-full bg-[#141414] border-2 border-[#FBBF24]/40 flex items-center justify-center z-10">
